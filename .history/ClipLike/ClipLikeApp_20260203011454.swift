...
final class SelectionService {
    ...
    private func fetchFocusedElement() -> AXUIElement? {
        ...
        if let focused = copyAttribute(systemWide, attribute: kAXFocusedUIElementAttribute) {
            return focused
        }
        ...
        if let focused = copyAttribute(appElement, attribute: kAXFocusedUIElementAttribute) {
            return focused
        }
        return nil
    }
